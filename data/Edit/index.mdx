---
title: Edit
description: How to Edit Table Data without coding
---
...
Then a prompt appears to select `Column with Unique Value` if the `Primary Key` is set in the table and then Click `OK` otherwise if primary is present in the table , it will directly save changes successfully in the database.
