...
There is a default limit of `100,000` rows. This can be adjusted in Settings, or changed as needed needed to fetch the desired number of rows. Once you've made your selection, press `Enter`.
